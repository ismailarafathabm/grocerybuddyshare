...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn" >
            <button ng-if="accesNewProduct" type="button" class="btn btn-added" ng-click="newProductModalshowhide('flex')"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Products</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
