                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr ng-repeat="x in newpurchaselist">
                                ...
                                <td><span>&#8377;</span> {{
                                    (+x.purchasepricewithgst).toLocaleString(undefined,{maximumFractionDigits:2})
                                }}</td>
                                <td><span>&#8377;</span>{{
                                    (+x.purchaseSubtot).toLocaleString(undefined,{maximumFractionDigits:2})
                                }}</td>
                    ...
                    <div class="total-order">
                        ...
                        <li>
                            ...
                            <li>
                                <h4>Discount  </h4>
                                <h5> {{
                                    (+invoiceinfo.dis).toLocaleString(undefined,{maximumFractionDigits:2})
                                }}</h5>
                            </li>
                            <li>
                                <h4>Sub Total</h4>
                                <h5> {{
                                    (+(+sumofinvoice)-(+invoiceinfo.dis)).toLocaleString(undefined,{maximumFractionDigits:2})
                                }} </h5>
                            </li>
                        </ul>
                    </div>
