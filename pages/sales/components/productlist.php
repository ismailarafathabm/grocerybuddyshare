                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-12">
                        <div class="form-group">
                            <div class="input-groupicon">
                                <input type="text" class="form-control" id="srcproductname_india" ng-model="srcproduct" />
                                <div class="addonset">
                    ...
                    <div class="col-lg-12 col-sm-12 col-12" style="max-height: 400px;overflow: auto;">
                        ...
                        <table class="table">
                            ...
                            <tr ng-repeat="x in productList | filter:srcproduct" ng-keydown="handlekeydown($event,x)" ng-class="{'selectrow' : $index === selectedIndex}" ng-focus="focusrow($index)" tabindex="0">
                                <td>{{$index+1}}</td>
