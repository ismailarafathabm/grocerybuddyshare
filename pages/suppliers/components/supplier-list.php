...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Suppliers</h4>
            <h6>Manage Supplier Informations</h6>
        </div>
        <div class="page-btn" >
            <button ng-if="newsupplieraccess" type="button" class="btn btn-added" ng-click="newSupplierModalhideshow('flex')"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Supplier</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
