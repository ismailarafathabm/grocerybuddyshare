...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Customers</h4>
            <h6>Manage Customer Informations</h6>
        </div>
        <div class="page-btn" style="display: none;">
            <button type="button" class="btn btn-added" ng-click="showNewBrandModal('flex')"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Brand</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
...
<?php 
    include_once './getpoints-list.php';
