...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn" >
            <button type="button" class="btn btn-added" ng-click="unittModelshowhidefun('flex')"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Units</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
